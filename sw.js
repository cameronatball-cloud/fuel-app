...
const VERSION = 'fuel-v20';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './planner.js', './data/ingredients.json', './data/recipes.json', './manifest.json', './icon-192.png', './icon-512.png'];
