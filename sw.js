...
const VERSION = 'fuel-v30';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './planner.js', './config.js', './cloud.js', './terms.html', './privacy.html', './data/ingredients.json', './data/recipes.json', './manifest.json', './icon-192.png', './icon-512.png'];
