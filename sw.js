...
const VERSION = 'fuel-v32';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './planner.js', './config.js', './cloud.js', './terms.html', './privacy.html', './data/ingredients.json', './data/recipes.json', './manifest.json', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './wordmark-light.svg', './wordmark.svg'];
